            ...
            <Suspense fallback={<Loading/>}>
                ...
                <Routes>
                    ...
                    <Route path="/assignments/edit/:id"
                           element={<ProtectedRoute><EditAssignment/></ProtectedRoute>}/>
                    <Route path="/restaurants" element={<ProtectedRoute><Restaurant/></ProtectedRoute>}/>
                    <Route path="/restaurants/detail/:id"
                           element={<ProtectedRoute><DetailRestaurant/></ProtectedRoute>}/>
                    <Route path="/restaurants/add"
                           element={<ProtectedRoute><CreateRestaurant/></ProtectedRoute>}/>
                    <Route path="/restaurants/edit/:id"
                           element={<ProtectedRoute><EditRestaurant/></ProtectedRoute>}/>
                    <Route path="/job-titles" element={<ProtectedRoute><JobTitle/></ProtectedRoute>}/>
                    <Route path="/job-titles/detail/:id"
                           element={<ProtectedRoute><DetailJobTitle/></ProtectedRoute>}/>
                    <Route path="/job-titles/add" element={<ProtectedRoute><CreateJobTitle/></ProtectedRoute>}/>
                    <Route path="/job-titles/edit/:id"
                           element={<ProtectedRoute><EditJobTitle/></ProtectedRoute>}/>
